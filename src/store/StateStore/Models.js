...
export const ModelSales = {
  ...
  currentPoints: types.optional(types.number, 0),
  ...
  priceModalVisible: types.optional(types.boolean, false),
    useLoyaltyPoints: types.optional(types.boolean, false),
  ...
  discountSelectionStatus: types.optional(types.string, "On The Fly Discount"),
  ...
  addReceiptLineStatus: types.optional(types.boolean, false),
    mobile_number: types.optional(types.string, ""),
};
