  ...
  _renderItem = ({ item, index }) => {
    return (
      <View style={{flexDirection: "row", marginTop: 5, height: 50, alignItems: "center" }}>
        <View style={{width: "50%"}}>
          <Text style={{ justifyContent:  "flex-start", marginLeft: 10 }}>{item.tax_type}</Text>

        </View>
        <View style={{width: "50%"}}>
          <Text style={{ justifyContent:  "flex-start", marginLeft: 10 }}>{item.tax_rate}</Text>
