...
import ModeOfPayment from "../../components/ModeOfPaymentComponent";
...
class Settings extends React.Component {
  ...
  renderMenu = () => {
    ...
    if (this.props.returnValue === strings.Queueing) {
      return (
        <Queue
          ...
          isOrderPrinting={values.orderPrinting}
          toggleOrderPrinting={toggleOrderPrinting}
          isTailOrderPrinting={values.tailOrderPrinting}
          toggleTailOrderPrinting={toggleTailOrderPrinting}
        />
      );
    }
    if (this.props.returnValue === "More...") {
      ...
      if (this.props.returnValue === "Mode of Payment") {
          return (
              <ModeOfPayment
