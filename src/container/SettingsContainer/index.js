...
export default class SettingsContainer extends React.Component {
  ...
  componentDidMount() {
    ...
    if (this.props.printerStore.sync.length > 0) {
      this.props.stateStore.changeValue("url", this.props.printerStore.sync[0].url, "Settings");
      this.props.stateStore.changeValue("user_name", this.props.printerStore.sync[0].user_name, "Settings");
      this.props.stateStore.changeValue("password", this.props.printerStore.sync[0].password, "Settings");
    ...
    if (this.props.printerStore.companySettings.length > 0) {
      ...
      this.props.stateStore.changeValue(
        "orderPrinting",
        this.props.printerStore.companySettings[0].orderPrinting,
        "Settings",
      );
      this.props.stateStore.changeValue(
        "allowRoundOff",
      ...
      this.props.stateStore.changeValue(
        "vat_number",
        this.props.printerStore.companySettings[0].vat_number.toString(),
        "Settings",
      );
      this.props.stateStore.changeValue(
        "ticket_number",
        this.props.printerStore.companySettings[0].ticket_number.toString(),
        "Settings",
      );
      this.props.stateStore.changeValue(
        "changeNoReceipts",
      ...
      this.props.stateStore.changeValue(
        "modeOfPayments",
        this.props.printerStore.companySettings[0].modeOfPayments.toString(),
        "Settings",
      );
      this.props.stateStore.changeValue(
        "companyHeader",
      ...
      [
        { text: strings.Cancel, style: "cancel" },
        {
          ...
          onPress: () => {
            ...
            this.props.printerStore.setDefaultPrinter(value.macAddress);
            Toast.show({
  ...
  onCompanySave = () => {
    ...
    if (this.props.printerStore.companySettings.length > 0) {
      ...
      company.edit({
        ...
        vat_number: this.props.stateStore.settings_state[0].vat_number,
  ...
  toggleOrderPrinting = () => {
    const { stateStore } = this.props;
    const { orderPrinting } = stateStore.settings_state[0];
    stateStore.changeValue("orderPrinting", !orderPrinting, "Settings");
    if (this.props.printerStore.companySettings.length > 0) {
      let company = this.props.printerStore.findCompany(
        this.props.printerStore.companySettings[0]._id,
      );
    ...
    toggleTailOrderPrinting = () => {
        const { stateStore } = this.props;
        const { tailOrderPrinting } = stateStore.settings_state[0];
        stateStore.changeValue("tailOrderPrinting", !tailOrderPrinting, "Settings");
        if (this.props.printerStore.companySettings.length > 0) {
            let company = this.props.printerStore.findCompany(
                this.props.printerStore.companySettings[0]._id,
            );
            company.edit({
                tailOrderPrinting: !tailOrderPrinting,
            });
        }
    };
    toggleLoyaltyProgram = () => {
        const { stateStore } = this.props;
        const { loyaltyProgram } = stateStore.settings_state[0];
        stateStore.changeValue("loyaltyProgram", !loyaltyProgram, "Settings");
        if (this.props.printerStore.companySettings.length > 0) {
            let company = this.props.printerStore.findCompany(
                this.props.printerStore.companySettings[0]._id,
            );
    ...
    changeMop = modeOfPayments => {
        const { stateStore, printerStore } = this.props;
        stateStore.changeValue("modeOfPayments", modeOfPayments, "Settings");
        let company = printerStore.findCompany(printerStore.companySettings[0]._id);
        company.edit({
  ...
  render() {
    ...
    return (
      <Settings
        ...
        toggleOrderPrinting={this.toggleOrderPrinting}
        toggleTailOrderPrinting={this.toggleTailOrderPrinting}
        toggleLoyaltyProgram={this.toggleLoyaltyProgram}
        modeOfPaymentData={modeOfPaymentStore.rows.slice()}
